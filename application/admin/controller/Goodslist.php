...
class Goodslist extends Common
{
            ...
            public function addAction()
            {
               ...
               // die;
                ...
                $arr1=Db::query("insert into huopin_goods (`goods_id`,`price`,`sn_number`,`goods_attr_id`) value ('$goods_id','$price','$sn_number','$goods_attr_id')");
            ...
            {   
                $data=Request::post();
                $goods_id=$data['goods_id'];
                $arr=Db::query("select * from huopin_goods where goods_id=$goods_id");
            ...
            public function delete()
            {
               $data=Request::post();
               $id=$data['id'];
               $arr=Db::query("delete from huopin_goods where id='$id'");
              ...
              public function updateAction()
            {
               ...
               $arr=Db::query("update huopin_goods set  price='$price',n_number='$n_number' where id='$id'");
